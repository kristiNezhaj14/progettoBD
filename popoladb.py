...
categories = [
    {'name': 'Electronics', 'image_url': 'laptop.jpeg'},
    {'name': 'Books', 'image_url': 'novel.jpeg'},
    {'name': 'Clothing', 'image_url': 'tshirt.jpeg'}
]
...
products = [
    ...
    {'name': 'Laptop', 'description': 'High-performance laptop', 'category_id': 1, 'price': 1299.99, 'quantity': 5, 'seller_id': 1, 'image_url': 'laptop.jpeg'},
    {'name': 'Tablet', 'description': 'Portable touchscreen tablet', 'category_id': 1, 'price': 499.99, 'quantity': 8, 'seller_id': 1, 'image_url': 'tablet.jpeg'},
    {'name': 'Smartwatch', 'description': 'Wearable smart device', 'category_id': 1, 'price': 199.99, 'quantity': 20, 'seller_id': 2, 'image_url': 'smartwatch.jpeg'},
    {'name': 'Camera', 'description': 'Digital camera with high resolution', 'category_id': 1, 'price': 899.99, 'quantity': 15, 'seller_id': 2, 'image_url': 'camera.jpeg'},
    {'name': 'Headphones', 'description': 'Noise-cancelling headphones', 'category_id': 1, 'price': 149.99, 'quantity': 30, 'seller_id': 2, 'image_url': 'headphones.jpeg'},
    {'name': 'Smart TV', 'description': '4K Ultra HD Smart TV', 'category_id': 1, 'price': 999.99, 'quantity': 3, 'seller_id': 3, 'image_url': 'smarttv.jpeg'},
    {'name': 'Bluetooth Speaker', 'description': 'Wireless portable speaker', 'category_id': 1, 'price': 79.99, 'quantity': 25, 'seller_id': 3, 'image_url': 'speaker.jpeg'},
    {'name': 'Drone', 'description': 'Quadcopter with 4K camera', 'category_id': 1, 'price': 599.99, 'quantity': 7, 'seller_id': 3, 'image_url': 'drone.jpeg'},
    {'name': 'Game Console', 'description': 'Next-gen gaming console', 'category_id': 1, 'price': 499.99, 'quantity': 12, 'seller_id': 3, 'image_url': 'console.jpeg'},

    # Books
    {'name': 'Novel', 'description': 'Bestselling novel', 'category_id': 2, 'price': 19.99, 'quantity': 20, 'seller_id': 1, 'image_url': 'novel.jpeg'},
    {'name': 'History Book', 'description': 'Comprehensive history book', 'category_id': 2, 'price': 29.99, 'quantity': 12, 'seller_id': 1, 'image_url': 'historybook.jpeg'},
    {'name': 'Science Book', 'description': 'Advanced science textbook', 'category_id': 2, 'price': 39.99, 'quantity': 10, 'seller_id': 2, 'image_url': 'sciencebook.jpeg'},
    {'name': 'Cookbook', 'description': 'Recipes from around the world', 'category_id': 2, 'price': 24.99, 'quantity': 15, 'seller_id': 2, 'image_url': 'cookbook.jpeg'},
    {'name': 'Biography', 'description': 'Biography of a famous figure', 'category_id': 2, 'price': 18.99, 'quantity': 18, 'seller_id': 2, 'image_url': 'biography.jpeg'},
    {'name': 'Fantasy Book', 'description': 'Epic fantasy novel', 'category_id': 2, 'price': 25.99, 'quantity': 25, 'seller_id': 3, 'image_url': 'fantasybook.jpeg'},
    {'name': 'Children\'s Book', 'description': 'Illustrated children\'s story', 'category_id': 2, 'price': 14.99, 'quantity': 30, 'seller_id': 3, 'image_url': 'childrensbook.jpeg'},
    {'name': 'Self-help Book', 'description': 'Book on personal development', 'category_id': 2, 'price': 19.99, 'quantity': 22, 'seller_id': 3, 'image_url': 'selfhelpbook.jpeg'},
    {'name': 'Thriller Book', 'description': 'Suspenseful thriller', 'category_id': 2, 'price': 21.99, 'quantity': 10, 'seller_id': 3, 'image_url': 'thrillerbook.jpeg'},
    {'name': 'Art Book', 'description': 'Artistic techniques and history', 'category_id': 2, 'price': 49.99, 'quantity': 8, 'seller_id': 3, 'image_url': 'artbook.jpeg'},

    # Clothing
    {'name': 'T-Shirt', 'description': 'Comfortable cotton t-shirt', 'category_id': 3, 'price': 9.99, 'quantity': 100, 'seller_id': 1, 'image_url': 'tshirt.jpeg'},
    {'name': 'Jeans', 'description': 'Denim jeans for everyday wear', 'category_id': 3, 'price': 39.99, 'quantity': 50, 'seller_id': 1, 'image_url': 'jeans.jpeg'},
    {'name': 'Jacket', 'description': 'Warm and stylish jacket', 'category_id': 3, 'price': 89.99, 'quantity': 25, 'seller_id': 2, 'image_url': 'jacket.jpeg'},
    {'name': 'Sneakers', 'description': 'Casual shoes for everyday wear', 'category_id': 3, 'price': 59.99, 'quantity': 40, 'seller_id': 2, 'image_url': 'sneakers.jpeg'},
    {'name': 'Dress', 'description': 'Elegant evening dress', 'category_id': 3, 'price': 79.99, 'quantity': 30, 'seller_id': 2, 'image_url': 'dress.jpeg'},
    {'name': 'Sweater', 'description': 'Warm wool sweater', 'category_id': 3, 'price': 49.99, 'quantity': 60, 'seller_id': 3, 'image_url': 'sweater.jpeg'},
    {'name': 'Shorts', 'description': 'Casual shorts for summer', 'category_id': 3, 'price': 19.99, 'quantity': 80, 'seller_id': 3, 'image_url': 'shorts.jpeg'},
    {'name': 'Hat', 'description': 'Stylish sun hat', 'category_id': 3, 'price': 15.99, 'quantity': 70, 'seller_id': 3, 'image_url': 'hat.jpeg'},
    {'name': 'Scarf', 'description': 'Cozy winter scarf', 'category_id': 3, 'price': 12.99, 'quantity': 50, 'seller_id': 3, 'image_url': 'scarf.jpeg'},
    {'name': 'Belt', 'description': 'Leather belt for men', 'category_id': 3, 'price': 25.99, 'quantity': 30, 'seller_id': 3, 'image_url': 'belt.jpeg'}
]
